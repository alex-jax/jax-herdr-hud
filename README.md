...
`herdr` once → **open Hud once (H enables automatically)** → **log out and back in**.
...
activity. Its outline follows your desktop accent colour. H enables automatically
on first launch; installation and extension updates require logout/login.
**Exit Hud** closes the app and hides H together; there is no separate H off control.
...
The H extension comes with the installer and enables automatically when Hud
starts. Exit Hud closes the app and hides H together.
