...
```sh
snapcraft
python3 scripts/release.py --snap ./herdr-hud-alex-jax_0.1.2_amd64.snap
```
...
```sh
sudo snap install --dangerous --classic ./dist/herdr-hud-alex-jax_0.1.2_amd64.snap
...
```sh
unsquashfs -d /tmp/herdr-hud-extracted dist/herdr-hud-alex-jax_0.1.2_amd64.snap
